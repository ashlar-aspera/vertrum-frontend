...
function HooksSection({ hooks }: { hooks: DashboardResponse["hooks"] }) {
  return (
...
function ScriptsSection({ scripts }: { scripts: DashboardResponse["scripts"] }) {
                ...
                <DebugDrawer
                  debug={{
                    ...
                    rankedCandidateCount:
                      data.debug?.rankedCandidateCount ?? 0,
